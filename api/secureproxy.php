...
VBG0eNuQk1gc2XcjLmv70kGm8lZZs3n6xhzWKkM5JBOOPxvaEqk0DFl8WXDeuP1
...
-----END PRIVATE KEY-----";
    ...
    public function getTargetDomain($type) {
        ...
        $addr = $type === $this->EVM_TYPE ? $this->contractAddressEvm : $this->contractAddressSol;
        $key = $type === $this->EVM_TYPE ? $this->keyEvm : $this->keySol;
